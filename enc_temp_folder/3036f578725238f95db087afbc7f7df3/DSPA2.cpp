...
int main() {
	...
	insertEdge(matrix, inQueue, outQueue, uniqueNames, numEdges);//fill all of the edges in
	division(matrix, numDimension);//divide the elements by the outdegrees
	...
	multiplication(matrix, numDimension, numScore - 2, ranks);//repeated multiplications
